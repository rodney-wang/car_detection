...
if __name__ == "__main__":
    ...
    videopath = '/mnt/bj-hdfs2/prod/customer/K11/gz/hk/videos/processed/body_temp/20190724/ch01001_20190724080000.mp4.cut.mp4'
    #Directory to store the processed frames
    dir = './keyframes_extract_result/'
    ...
    while(success):
        ...
        curr_frame = luv
        curr_frame = cv2.resize(curr_frame, (50, 50))
        ...
        prev_frame = cv2.resize(prev_frame, (50, 50))
        i = i + 1
        if i % 100 == 0:
            print('%d frames have been processed' % i)
        success, frame = cap.read()   
    cap.release()
